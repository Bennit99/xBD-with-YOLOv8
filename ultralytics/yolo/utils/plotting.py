...
class Colors:
    ...
    def __init__(self):
        ...
        hexs = ('00FA00', 'FFFF00', 'FF0000', 'C800FF', 'FFFFFF', '48F90A', '92CC17', '3DDB86', '1A9334', '00D4BB',
...
def plot_images(images,
    ...
    for i, im in enumerate(images):
        ...
        ''' plot pre and post disater image next to each other, when im.shape[2] = 6 '''
        if im.shape[2]/3 > 1:
            # only select one
